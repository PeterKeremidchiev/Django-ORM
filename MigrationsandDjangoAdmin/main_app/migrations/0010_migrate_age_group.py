# Generated by Django 4.2.4 on 2023-10-24 16:02
...
def set_age_group_reverse(apps, schema_editor):
    person_model = apps.get_model('main_app', 'Person')
    ...
    person_model.objects.bulk_update(person_model.objects.all(), ['age_group'])
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(set_age_group, reverse_code=set_age_group_reverse)
    ]
